...
const metadata = {
    ...
    description: "INOZET MD - Myo-inositol, D-xiro-inositol va Metafolin kombinatsiyasi. Gormonal muvozanat, reproduktiv salomatlik va PCOS muammolarini hal qilish uchun tabiiy yechim.",
    generator: "v0.app",
    keywords: "INOZET, HERBALAB, myo-inositol, d-chiro-inositol, metafolin, PCOS, gormonal muvozanat, reproduktiv salomatlik, hayzli tsikl, ovulyatsiya",
    icons: {
        icon: [
            {
