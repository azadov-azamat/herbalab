    ...
    <section id="aloqa" className="py-16 md:py-24 bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-balance">Biz bilan bog'laning</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <Card className="p-6 hover:shadow-lg transition-all">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Telefon raqamlar</h3>
          ...
          <div className="flex justify-center">
            <Card className="p-6 max-w-sm">
              <h3 className="text-xl font-bold mb-4 text-center">Instagram QR kod</h3>
              <Image
